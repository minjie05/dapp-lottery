  ...
  return (
    <div className="px-5 bg-slate-100 py-10 h-[90vh]">
      <div className="flex flex-col items-center justify-center text-center py-10">
        <h4 className="text-4xl text-slate-700 font-bold pb-3">Buy Lottery Online</h4>
      ...
      <div className="flex flex-col justify-end items-center mb-10 space-y-4">
        {jackpot?.expiresAt ? <CountDown timestamp={jackpot?.expiresAt}></CountDown> : null}
      ...
      <div className="bg-white text-sm w-full sm:w-3/4 mx-auto p-10 rounded-md flex flex-col">
        <div className="pb-4 text-center">
          <p className="text-2xl font-semibold">Select Your winning Lottery Numbers</p>
        </div>
