  ...
  return (
    <div className="w-full rounded-lg shadow-lg shadow-grey bg-[#fff7ed] overflow-hidden px-3 py-5 my-2">
      <div className="flex justify-start items-center space-x-2">
        <Image width={80} height={80} src={jackpot.image} alt="icon" className="w-20 rounded-lg" />
        <div>
          <p className="text-[#c2410c] font-bold">Upto: {jackpot.price} ETH</p>
          <p className="text-gray-500 font-medium">Draws On: {jackpot.drawsAt}</p>
        </div>
      </div>
      <div className="py-5">
        <p className="text-[#c2410c] font-bold">{jackpot.title}</p>
        <p className="text-gray-500 font-medium">{jackpot.description}</p>
      </div>
      <Link
